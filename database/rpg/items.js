...
const items = [
    ...
    // === CONSUMABLE ITEMS ===
    { nama: "Potion HP", hargaJual: 20, hargaBeli: 50, kategori: 'Consumable', deskripsi: "Memulihkan 50 HP" },
    { nama: "Potion Mana", hargaJual: 15, hargaBeli: 40, kategori: 'Consumable', deskripsi: "Memulihkan 30 Mana" },
    { nama: "Elixir Kekuatan", hargaJual: 30, hargaBeli: 80, kategori: 'Consumable', deskripsi: "Meningkatkan Attack sementara" },
    { nama: "Elixir Pertahanan", hargaJual: 30, hargaBeli: 80, kategori: 'Consumable', deskripsi: "Meningkatkan Defense sementara" },
    ...
    { nama: "Belati Bayangan Elite", hargaJual: 700, hargaBeli: 3600, kategori: 'RARE', tipe: 'senjata', stats: { attack: 56 } },
    ...
    { nama: "Tongkat Sihir Starter", hargaJual: 1, hargaBeli: 0, kategori: 'Peralatan', tipe: 'senjata', stats: { attack: 5, mana: 20 } },
...
{ nama: "Batu Kosmos", hargaJual: 5000, hargaBeli: 0, kategori: 'Mineral', rarity: 'Legendary', chance: 0.02 },
    ...
    // ========== PERALATAN DENGAN DURABILITY ==========
    
    // --- Pancingan Kayu ---
    { nama: "Pancingan Kayu", hargaJual: 50, hargaBeli: 200, kategori: 'Peralatan', tipe: 'pancingan', durability: 40, maxDurability: 40, tier: 'kayu', stats: { fishing: 1 } },
    
    // --- Pancingan Batu ---
    { nama: "Pancingan Batu", hargaJual: 120, hargaBeli: 480, kategori: 'Peralatan', tipe: 'pancingan', durability: 80, maxDurability: 80, tier: 'batu', stats: { fishing: 2 } },
    
    // --- Pancingan Besi ---
    { nama: "Pancingan Besi", hargaJual: 300, hargaBeli: 1200, kategori: 'Peralatan', tipe: 'pancingan', durability: 150, maxDurability: 150, tier: 'besi', stats: { fishing: 3 } },
    
    // --- Pancingan Diamond ---
    { nama: "Pancingan Diamond", hargaJual: 800, hargaBeli: 3200, kategori: 'RARE', tipe: 'pancingan', durability: 300, maxDurability: 300, tier: 'diamond', stats: { fishing: 5 } },
    
    // --- Pancingan Netherite ---
    { nama: "Pancingan Netherite", hargaJual: 2000, hargaBeli: 8000, kategori: 'EPIC', tipe: 'pancingan', durability: 500, maxDurability: 500, tier: 'netherite', stats: { fishing: 8 } },
    
    // --- Kapak Kayu ---
    { nama: "Kapak Kayu", hargaJual: 60, hargaBeli: 240, kategori: 'Peralatan', tipe: 'kapak', durability: 50, maxDurability: 50, tier: 'kayu', stats: { chopping: 1 } },
    
    // --- Kapak Batu ---
    { nama: "Kapak Batu", hargaJual: 150, hargaBeli: 600, kategori: 'Peralatan', tipe: 'kapak', durability: 100, maxDurability: 100, tier: 'batu', stats: { chopping: 2 } },
    
    // --- Kapak Besi ---
    { nama: "Kapak Besi", hargaJual: 400, hargaBeli: 1600, kategori: 'Peralatan', tipe: 'kapak', durability: 200, maxDurability: 200, tier: 'besi', stats: { chopping: 3 } },
    
    // --- Kapak Diamond ---
    { nama: "Kapak Diamond", hargaJual: 1000, hargaBeli: 4000, kategori: 'RARE', tipe: 'kapak', durability: 400, maxDurability: 400, tier: 'diamond', stats: { chopping: 5 } },
    
    // --- Kapak Netherite ---
    { nama: "Kapak Netherite", hargaJual: 2500, hargaBeli: 10000, kategori: 'EPIC', tipe: 'kapak', durability: 600, maxDurability: 600, tier: 'netherite', stats: { chopping: 8 } },
    
    // --- Beliung Kayu ---
    { nama: "Beliung Kayu", hargaJual: 70, hargaBeli: 280, kategori: 'Peralatan', tipe: 'beliung', durability: 60, maxDurability: 60, tier: 'kayu', stats: { mining: 1 } },
    
    // --- Beliung Batu ---
    { nama: "Beliung Batu", hargaJual: 180, hargaBeli: 720, kategori: 'Peralatan', tipe: 'beliung', durability: 120, maxDurability: 120, tier: 'batu', stats: { mining: 2 } },
    
    // --- Beliung Besi ---
    { nama: "Beliung Besi", hargaJual: 450, hargaBeli: 1800, kategori: 'Peralatan', tipe: 'beliung', durability: 250, maxDurability: 250, tier: 'besi', stats: { mining: 3 } },
    
    // --- Beliung Diamond ---
    { nama: "Beliung Diamond", hargaJual: 1200, hargaBeli: 4800, kategori: 'RARE', tipe: 'beliung', durability: 500, maxDurability: 500, tier: 'diamond', stats: { mining: 5 } },
    
    // --- Beliung Netherite ---
    { nama: "Beliung Netherite", hargaJual: 3000, hargaBeli: 12000, kategori: 'EPIC', tipe: 'beliung', durability: 800, maxDurability: 800, tier: 'netherite', stats: { mining: 8 } },
    
    // --- Sekop Kayu (Bonus) ---
    { nama: "Sekop Kayu", hargaJual: 40, hargaBeli: 160, kategori: 'Peralatan', tipe: 'sekop', durability: 30, maxDurability: 30, tier: 'kayu', stats: { digging: 1 } },
    
    // --- Sekop Batu ---
    { nama: "Sekop Batu", hargaJual: 100, hargaBeli: 400, kategori: 'Peralatan', tipe: 'sekop', durability: 60, maxDurability: 60, tier: 'batu', stats: { digging: 2 } },
    
    // --- Sekop Besi ---
    { nama: "Sekop Besi", hargaJual: 250, hargaBeli: 1000, kategori: 'Peralatan', tipe: 'sekop', durability: 120, maxDurability: 120, tier: 'besi', stats: { digging: 3 } },
    
    // --- Sekop Diamond ---
    { nama: "Sekop Diamond", hargaJual: 600, hargaBeli: 2400, kategori: 'RARE', tipe: 'sekop', durability: 200, maxDurability: 200, tier: 'diamond', stats: { digging: 5 } },
    
    // --- Sekop Netherite ---
    { nama: "Sekop Netherite", hargaJual: 1500, hargaBeli: 6000, kategori: 'EPIC', tipe: 'sekop', durability: 300, maxDurability: 300, tier: 'netherite', stats: { digging: 8 } },

    { nama: "Teleporting Stone", hargaJual: 1000, hargaBeli: 300, kategori: 'Consumable', deskripsi: 'Batu ajaib untuk teleport ke lokasi manapun' },
