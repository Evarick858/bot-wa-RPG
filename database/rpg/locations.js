...
const locations = [
    ...
    },
    {
        ...
        koneksi: ["Desa Awal", "Goa Misterius", "Rawa Kabut"],
        aksi: ["hunt", "nebang"]
    },
    {
        nama: "Goa Misterius",
    ...
    },
    {
        ...
        koneksi: ["Rawa Kabut", "Dermaga Tua", "Toko peralatan mas Buudi"],
        aksi: ["hunt", "mancing"]
    },
    {
        nama: "Toko peralatan mas Buudi",
        deskripsi: "Asap dari tungku pembakaran mengepul di udara, diiringi oleh suara dentingan palu yang berirama. Berbagai macam alat dan senjata terpajang rapi di dinding.",
        koneksi: ["Pesisir Pantai"],
        aksi: ["toko"]
    },
    {
        nama: "Dermaga Tua",
    ...
    },
    {
        ...
        koneksi: ["Pulau Karang", "Mineshaft"],
        aksi: ["hunt", "nebang"]
    },
    {
        nama: "Mineshaft",
        deskripsi: "Udara terasa dingin dan lembap di dalam lubang tambang yang gelap ini. Pilar-pilar kayu tua menopang langit-langit gua yang rendah, dan rel kereta tambang yang berkarat menghilang ke dalam kegelapan. Dinding batu sesekali berkilauan oleh urat bijih besi dan tembaga, serta jamur bercahaya yang memberikan penerangan redup, crepee??? er?",
        koneksi: ["Hutan Tropis"],
        aksi: ["nambang"]
    },
    ...
    // ========== KAWASAN GURUN (THE ARID WASTES) [5 Lokasi] ==========
    {
        ...
        koneksi: ["Gunung Berapi", "Oasis Tersembunyi", "Reruntuhan Kuno", "Danau Tenang"],
        aksi: ["hunt"]
    },
    {
        nama: "Danau Tenang",
    ...
    },
    {
        ...
        deskripsi: "Ruangan berisi gulungan dan buku-buku kuno yang terawat sempurna dalam lapisan es tipis. Di salah satu sudut, ada meja tua dengan berbagai artefak teleportasi yang misterius.",
        koneksi: ["Altar Es"],
        aksi: ["shop"]
    },
...
},
{
    ...
    deskripsi: "Sebuah kota yang megah dibangun di atas awan tebal. Bangunannya terbuat dari marmer putih dan dihiasi kristal angin yang berdengung lembut. Udara segar dan energi magis membuat pemulihan lebih cepat di sini.",
...
},
{
    ...
    koneksi: ["Avanthoria, Kota Awan", "Altar Badai", "Toko Sihir Bu Winda"],
    aksi: ["hunt", "nambang"]
},
{
    nama: "Toko Sihir Bu Winda",
    deskripsi: "Aroma dupa dan ramuan herbal menyambut siapa pun yang masuk. Rak-rak kayu penuh dengan botol-botol ramuan berwarna-warni, buku-buku kuno berjilid kulit, dan artefak aneh yang memancarkan cahaya redup. Bu Winda sendiri biasanya terlihat di belakang meja, meracik sesuatu dengan senyum misterius.",
